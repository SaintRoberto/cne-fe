    ...
    <div className="coe-page infraestructuras-import-page">
      <section className="module-strip">
        <div>
          ...
          <h2>Importar infraestructuras desde CSV</h2>
          <p>Cargue los recintos electorales después de haber actualizado el maestro DPA.</p>
        </div>
        <FileUp size={42} />
      </section>
      ...
      <Card className="functional-card maestro-dpa-card">
        ...
        <Typography.Paragraph type="secondary">
          El archivo se validará antes de crear o actualizar las infraestructuras. Solo se admite un archivo CSV de hasta 5 MB.
        ...
        {summary ? <Alert className="dpa-alert" type="success" showIcon icon={<CheckCircleOutlined />} title={summary.mensaje || 'Importación de infraestructuras completada'} description={
